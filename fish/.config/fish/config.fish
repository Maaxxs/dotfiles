...
alias muttconf='$EDITOR ~/.config/neomutt/neomuttrc'
...
alias fixme='$EDITOR ~/notes/fm/fixme.md'
alias lg='lazygit'
alias news='newsboat'
alias dn='$EDITOR ~/notes/daily-notes/(date +%Y-%m-%d).md'
alias tn='$EDITOR ~/notes/daily-notes/(date --date="tomorrow" +%Y-%m-%d).md'
alias yn='$EDITOR ~/notes/daily-notes/(date --date="yesterday" +%Y-%m-%d).md'
alias uid='head -c30 /dev/urandom | base64 | tr -d "=/"'
alias pandock='docker run --rm -v "$(pwd):/data" -u $(id -u):$(id -g) pandoc/extra'
# alias mmut='mailsync.sh && mut'
alias mmail='mail sync'
alias jour='$EDITOR ~/notes/journal.md'
#alias man='if test (tput cols) -gt 80; set -gx MANWIDTH 80; else; set -e MANWIDTH; end && man'
#alias cal='nvim +0 +/$(date -I) +nohl calendar.txt
alias ccc '$EDITOR ~/notes/39c3/notes.md'
alias mov '$EDITOR movie-list.txt'
alias reading '$EDITOR ~/reading-list.md'
alias movies '$EDITOR movie-list.txt'
alias todos '$EDITOR ~/nc/todo.txt'
alias research '$EDITOR ~/nc/todo.research.txt'
alias thesis '$EDITOR ~/nc/AIM/thesis/thesis.md'
alias thunarr 'thunar . &>/dev/null &; disown'
